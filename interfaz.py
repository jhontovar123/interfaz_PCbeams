...
def user_input_features():
    ...
    rho_l = st.sidebar.slider('rho_l', min_value=0.00, max_value=0.2, step=0.001)
    rho_lp = st.sidebar.slider('rho_lp', min_value=0.01, max_value=0.06, step=0.01) 
    rho_t = st.sidebar.slider('rho_t', min_value=0.0, max_value=0.05, step=0.01) 
